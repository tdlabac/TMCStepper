...
///////////////////////////////////////////////////////////////////////////////////////
// R+C: GSTAT
template<class T> uint8_t TMCStepper<T>::GSTAT()  { return read(GSTAT_address); }
template<class T> void  TMCStepper<T>::GSTAT(uint8_t){ write(GSTAT_address, 0b111); }
template<class T> bool  TMCStepper<T>::reset()    { GSTAT_t r{0}; r.sr = GSTAT(); return r.reset; }
template<class T> bool  TMCStepper<T>::drv_err()  { GSTAT_t r{0}; r.sr = GSTAT(); return r.drv_err; }
template<class T> bool  TMCStepper<T>::uv_cp()    { GSTAT_t r{0}; r.sr = GSTAT(); return r.uv_cp; }
///////////////////////////////////////////////////////////////////////////////////////
// W: TPOWERDOWN
...
///////////////////////////////////////////////////////////////////////////////////////
// R: TSTEP
template<class T> uint32_t TMCStepper<T>::TSTEP() { return read(TSTEP_address); }
///////////////////////////////////////////////////////////////////////////////////////
// W: TPWMTHRS
...
template<class T> uint32_t TMCStepper<T>::MSCURACT() { return read(MSCURACT_address); }
